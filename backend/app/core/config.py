...
class Settings(BaseSettings):
    ...
    drone_min_confidence: float = 0.25
    airplane_min_confidence: float = 0.25
    helicopter_min_confidence: float = 0.22
    bird_min_confidence: float = 0.45
    flying_model_imgsz: int = 960

    flying_min_box_px: int = 4
    flying_max_box_area_ratio: float = 0.90
    flying_max_center_y_ratio: float = 0.98
