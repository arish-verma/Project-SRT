...
class AlertStore:
    def __init__(self, db_path="storage/srt_events.db"):
        ...
        with sqlite3.connect(self.path) as db:
            db.execute(
                "CREATE TABLE IF NOT EXISTS alerts (alert_id TEXT PRIMARY KEY,event_id TEXT NOT NULL UNIQUE,camera_id TEXT NOT NULL,created_at TEXT NOT NULL,severity TEXT NOT NULL,title TEXT NOT NULL,message TEXT NOT NULL,status TEXT NOT NULL)"
            )
